...
const Guide = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h2 className="text-xl md:text-2xl font-semibold mb-4">1. Connect Your GitHub Account</h2>
        ...
        <Accordion type='single' collapsible className='w-full border p-4 rounded-lg border-gray-700 bg-gray-800/30 my-6'>
          <AccordionItem value='item-1'>
            ...
            <AccordionContent className='mt-4'>
              <ol className="list-decimal max-md:text-sm list-inside space-y-3 mb-4 text-gray-300">
                ...
                <li>Click "Generate token" at the bottom of the page (we recommend to set no expiry for this token)</li>
